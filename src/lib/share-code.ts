...
export const SHARE_CODE_VERSION = 4;
...
export const SHARE_CODE_ORDER_V4: readonly BeliefId[] = [
  ...SHARE_CODE_ORDER_V3,
  "limitedGod",
  "agnosticismAboutGod",
  "noMoralTruths",
...
const CURRENT_SHARE_CODE_ORDER = SHARE_CODE_ORDER_V4;
